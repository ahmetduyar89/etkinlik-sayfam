    ...
    return (
        <div className="fixed inset-0 z-[5100] pointer-events-none flex items-center justify-center p-3 sm:p-6 overflow-hidden">
            <motion.div
                ...
                className={cn(
                    'pointer-events-auto flex flex-col bg-[#13151f]/95 backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-2xl overflow-hidden select-none',
            ...
            >
                ...
                <div
                    ...
                    className={cn(
                        'flex items-center justify-between px-4 py-2.5 bg-gradient-to-r from-purple-950/80 via-[#1a172c] to-[#13151f] border-b border-white/10 select-none cursor-grab active:cursor-grabbing',
