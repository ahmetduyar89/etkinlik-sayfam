            ...
            <div className="flex justify-between items-center w-full px-8 py-5 max-w-screen-2xl mx-auto">
                <div className="flex items-center gap-10">
                    ...
                    <nav className="hidden md:flex items-center space-x-6">
                        ...
                        <a className="text-on-surface-variant hover:text-white transition-colors text-sm font-semibold antialiased" href="#">Categories</a>
                        <a className="text-on-surface-variant hover:text-white transition-colors text-sm font-semibold antialiased" href="#">About</a>
                    </nav>
                </div>
