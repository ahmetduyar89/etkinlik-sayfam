...
const GUNES_SISTEMI_ACTIVITY: Activity = {
    ...
    description: '8 gezegen, NASA Eyes canlı uzay gözlemi, yörüngeler, 23.5° eksen eğikliğiyle mevsimler, tutulmalar ve yerçekimi laboratuvarı.',
    category: 'Simülasyon',
    subject: 'Fen Bilimleri',
    grade_level: '7',
    unit: 'Güneş Sistemi ve Ötesi',
    tags: 'uzay, gezegenler, güneş sistemi, nasa, nasa eyes, 3d, mevsimler, tutulmalar, yerçekimi, planetaryum',
    is_test: false,
