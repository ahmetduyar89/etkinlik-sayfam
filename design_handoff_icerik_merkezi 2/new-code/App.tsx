...
// ↓↓↓ Mevcut App.tsx'indeki MOCK_ACTIVITIES'i AYNEN koru (kısaltıldı). ↓↓↓
const MOCK_ACTIVITIES: Activity[] = [
    { id: 'mock1', title: 'Kuantum Alanları', description: 'Elektronların gizemli dünyasını interaktif simülasyonla deneyimleyin.', category: 'Simülasyon', subject: 'Fizik', grade_level: '12', tags: 'kuantum, fizik, atom', is_test: false },
    { id: 'mock2', title: 'Genetik Temeller', description: 'DNA sarmalı ve kalıtımın mekanizmalarını derinlemesine inceleyin.', category: 'Ders Notları', subject: 'Biyoloji', grade_level: '10', tags: 'dna, genetik, biyoloji', is_test: false },
    { id: 'mock4', title: 'Asit-Baz Dengesi', description: 'Etkileşimli titrasyon deneyi.', category: 'Laboratuvar', subject: 'Kimya', grade_level: '11', tags: 'kimya, asit, baz', is_test: false },
    { id: 'mock5', title: 'Haftalık Test', description: 'Fizik ve Kimya üzerine haftalık değerlendirme testi.', category: 'Test', subject: 'Fizik', grade_level: '11', tags: 'fizik, kimya, test', is_test: true },
    { id: 'mock7', title: 'Matematik Lab', description: 'Matematik formüllerini görselleştirin.', category: 'Laboratuvar', subject: 'Matematik', grade_level: '8', tags: 'matematik, geometri', is_test: false },
    { id: 'mock9', title: 'Mikro Dünya', description: 'Mikroskobik organizmaları keşfedin.', category: 'Laboratuvar', subject: 'Biyoloji', grade_level: '10', tags: 'mikroskop, hücre', is_test: false },
];
